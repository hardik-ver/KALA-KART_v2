    ...
    <div className="flex flex-col h-full bg-kk-surface text-kk-ink p-4 sm:p-5 overflow-y-auto font-sans">
      ...
      <div className="flex items-center justify-between gap-2 pb-3 border-b border-kk-line">
        ...
        <button
          type="button"
          onClick={onAddNew}
          className="flex items-center gap-1 px-3 py-1.5 bg-kk-primary hover:bg-kk-primary-dark text-white rounded-xl text-xs font-bold shadow-xs active:scale-95 transition-all"
        >
      ...
      <div className="mt-3.5 space-y-2">
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full h-10 pl-9 pr-4 rounded-xl bg-white border border-kk-line text-xs font-medium text-kk-ink focus:outline-none focus:border-kk-primary focus:ring-2 focus:ring-kk-primary/20 shadow-xs"
          />
        </div>
      ...
      {/* Items List */}
      <div className="mt-3 space-y-3 flex-1 pb-28 md:pb-8">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-1">
                      <h4 className="font-extrabold text-xs sm:text-sm text-kk-ink leading-snug line-clamp-1">
                    ...
                    <div className="flex items-center justify-between mt-2">
                      <span className="text-sm font-black text-kk-primary">
      ...
      {selectedQrItem && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-sm w-full p-5 border border-kk-line shadow-2xl text-center space-y-3">
            <h3 className="text-sm font-black text-kk-ink">
            ...
            <div className="p-4 bg-stone-50 rounded-2xl border border-kk-line inline-block">
              <img
            ...
            <button
              ...
              className="w-full py-2.5 bg-kk-ink text-white rounded-xl text-xs font-bold hover:bg-kk-ink-soft"
            >
              Close
            </button>
          </div>
