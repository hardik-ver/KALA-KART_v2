...
export const SellerWorkspace: React.FC<SellerWorkspaceProps> = ({
  ...
  return (
    <div className="flex flex-col w-full h-full bg-kk-surface text-kk-ink overflow-hidden select-none">
            ...
            <AnimatePresence>
              {showAdminMenu && (
                <motion.div
                  ...
                  className="absolute right-0 top-12 w-64 bg-white rounded-2xl border border-kk-line shadow-xl p-3 space-y-2 z-50"
                  role="dialog"
      ...
      {/* Native Mobile Floating Glass Dock (Home, Inventory, Add Craft, Orders, Account) */}
      {!isSellFlow && (
        <SellerBottomNav
